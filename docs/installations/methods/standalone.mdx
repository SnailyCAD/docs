...
- [Node.js](https://nodejs.org) **(22.18.x is supported.)** ([Windows Guide](https://youtu.be/qfo5MaqQgIo)) ([Linux Guide](/docs/guides/requirements/how-to-install-node-pnpm-npm-linux))
...
- [PostgreSQL](https://www.postgresql.org/download/) **(version 15 or higher)** ([Video Guide](https://www.youtube.com/watch?v=ZKWZvafvqwM)) ([Linux Guide](/docs/guides/requirements/how-to-install-postgresql-linux))
