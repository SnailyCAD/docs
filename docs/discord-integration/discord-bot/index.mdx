...
- [yarn](https://npmjs.com/package/yarn) **(`npm install --global yarn`)** ([Windows Guide](https://youtu.be/rp308wNdXU8)) ([Linux Guide](/docs/guides/requirements/how-to-install-node-pnpm-npm-linux#yarn))
