...
With values you are able to manage vehicles, weapons, genders and much more!
These values are used when a vehicle/weapon is registered, citizen is created respectively.
